page 50025 ServiceItems
{
    APIGroup = 'Service';
    APIPublisher = 'Quantron';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'serviceitems';
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                part(Components; ServiceItemComponents)
                {
                    ...
                    Enabled = true;
                    Caption = 'Components';
                    SubPageLink = "Parent Service Item No." = field("No."), Active = const(true);
                }
            }
        }
    }
