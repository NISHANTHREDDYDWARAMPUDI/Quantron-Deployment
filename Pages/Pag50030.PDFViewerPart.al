page 50030 PDFViewerPart
{
    ...
    begin
        OpenPdfViewerMeth.OpenPdfViewer(DocumentCapturingHdr, DocumentCapturingHdr.FieldNo(Attachment), Popup);
    end;
    ...
    procedure LoadPdfFromBase64(Base64Data: Text; var DocCapturingHdr: Record "Document Capturing Header")
    begin
        DocumentCapturingHdr := DocCapturingHdr;
        Clear(Data);
