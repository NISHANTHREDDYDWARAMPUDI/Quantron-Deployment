report 50014 ExportAccouScheduleToExcelNew
{
    UseRequestPage = false;
    ApplicationArea = All;
    ProcessingOnly = true;
    Caption = 'Export Account Schedule To Excel New';
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            begin
                        ...
                        if ColumnLayout.Find('-') then
                            repeat
                                ...
                                EnterCell(
                                  ...
                                  AccSchedLine.Bold, AccSchedLine.Italic, AccSchedLine.Underline, AccSchedLine."Double Underline",
                                  '#,##0.00', TempExcelBuffer."Cell Type"::Number)
                            until ColumnLayout.Next() = 0;
                ...
                if DoUpdateExistingWorksheet then begin
                    ...
                    // TempExcelBuffer.UpdateBookStream(ServerFileName, SheetName, false);
                    TempExcelBuffer.WriteSheet('', CompanyName, UserId);
                    TempExcelBuffer.CloseBook();
                    if not TestMode then
                        TempExcelBuffer.SetFriendlyFilename(ClientFileName);
                end else begin
